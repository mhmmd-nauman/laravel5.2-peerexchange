                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('market.sell') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="fromCurrency" class="col-sm-2 control-label">Balance Currency</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label for="toCurrency" class="col-sm-2 control-label">Target Currency</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label for="rate" class="col-sm-2 control-label">Exchange Rate</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label for="toAmount" class="col-sm-2 control-label">Target Currency Amount</label>
                                <div class="col-sm-3">
                                    <input type="number" class="form-control"
